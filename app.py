...
file_path = os.path.join(os.path.dirname(file), "data.csv")df = pd.read_csv(file_path)
...
with st.spinner("Training model..."):model, results, feature_cols, X_test, y_test, cv_score = train_models(df)
